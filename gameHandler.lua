...
local statName = {
	...
	accidents = "Crashes",
	drunkArrivals_sinceDrunkAccident = "Patrons safely home (in a row)",
	drunkArrivals_new = "Patrons safely home",
	sickDeaths = "Fatal illnesses",
	returnedToDoctor = "Patients treated",
	doctorVisitHouse = "Patients picked up",
	drunkArrivals_sinceCaught = "Patrons returned un-arrested (in a row)",
